...
public class ShapesModelNVL2 {
    ...
    public void startNewRound() {
        ...
        //Los 4 enteros que hacen referencia a los recursos de las figuras reciben su valor de los elementos en el arreglo "figures"
        ...
        drags.clear();
        //Se añaden los primeros 4 valores del arreglo "figures" en "drags"
        drags.addAll(figures.subList(0, 4));
        //Los elementos en el arreglo "drags" se revuelven a través del método shuffle
        Collections.shuffle(drags);
        //Los 4 enteros que hacen referencia a los recursos de los elementos de arrastre reciben su valor de los elementos en el arreglo "drags"
